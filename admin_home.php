...
<body>
	...
	<button onclick="location.href='admin_see_client.php'" type="button" class ="btn btn-primary"> See All Customers </button>
	<button onclick="location.href='admin_see_salesman.php'" type="button" class ="btn btn-primary"> See All Sellers </button>
