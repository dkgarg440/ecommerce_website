...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align height:150%">
  ...
  <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium ">
    <a href="#team" class="w3-bar-item w3-button">DEVELOPER</a>
...
<div class="w3-half ">
  <img src="images/ij.jpg" alt="deepak" style="width:45% " class="w3-circle w3-hover-opacity">
  <h3>Deepak Kumar</h3>
  <!-- <p>Front -End and DataBase</p> -->
</div>



<div class="w3-half">
  <img src="images/rj1.jpg" alt="Rahul Jain" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3>Rahul Jain</h3>
...
<div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-teal w3-bottombar">Contact Us</span></div>
      ...
      <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i>  +91 9306120572(Deepak) </p>
      <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i>  +91 9412291111(Rahul Jain) </p>
      <p><i class="fa fa-envelope-o w3-text-teal w3-xlarge"></i>  dk5285991@gmail.com</p>
    </div>
    <div class="w3-col m7">
...
<footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
  <h4>Follow Us</h4>
  <a class="w3-button w3-large w3-teal" href="https://www.facebook.com/lavish.nagar.1297" title="Facebook"><i class="fa fa-facebook"></i></a>
